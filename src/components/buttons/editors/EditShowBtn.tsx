...
export const EditShowBtn = ({item, contentLink}:{item: any, contentLink: string}) => {
  ...
  const editDatabase = (values: IContentShows) => {
                ...
                return (
                  <Form noValidate onSubmit={handleSubmit}>
                    ...
                    {item.linkVideo &&
                      ...
                      <Row className="mb-3">
                        <Form.Group as={Col} controlId="validationFormik02">
                          <Form.Label> Link (min: 4, max:12 only Eng Letter) </Form.Label>
                          <Form.Control
                            type="string"
                            name="link"
                            value={values.link}
